...
class View_wData_User implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            f.setVisible(false);
            Print_Data_User p=new Print_Data_User(t.getText(),t1.getText()); //function to print out data
        }

    }

    public static void main(String[]ar){
        View_wData_User v=new View_wData_User();
    }
}