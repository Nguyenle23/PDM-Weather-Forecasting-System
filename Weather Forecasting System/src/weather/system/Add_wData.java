...
class Add_wData implements ActionListener{
    ...
    Add_wData(){
        ...
        id8 = new JLabel("New Weather Data");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        //get all the text filled in the text fields
        String a = t1.getText();
        ...
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                //sql statement to insert all the inputted text into the weatherData table
                String q = "insert into weatherData values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"')";
                cc.s.executeUpdate(q); //execute the statement
